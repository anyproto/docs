...
1. **Block Links** — Type `/link`. These appear cards.
...
You can link to a specific date typing the `@date` shortcut in the editor. Alternatively, you can type `@today`, `@tomorrow`, or `@specific date`. You can also click into a specific date block to reveal objects related to that date.&#x20;
