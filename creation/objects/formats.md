...
You can change how a Page is structured to suit your needs. A Page's layout is determined by the Type, where the same layout is applied to all objects of the same [Type](../../organize/types.md). You can choose from:&#x20;
...
You can change how the Properties of an Object is displayed. There is an 'Line' layout and 'List' layout. This setting will apply across all Objects of the same Type. Learn more in the [Properties section](../../organize/relations.md#properties-in-the-object-header).&#x20;
