...
* **Type** — A database-style experience for multiple Objects.&#x20;
...
* **Basic** — Standard layout that acts as a baseline
* **Profile** — Adds an image to the title area (for people and companies)
