...
Anytype does not save a copy of your Key, which means that if it's lost, we are not able to assist with recovering your Vault. For this reason, we recommend making a digital backup, writing it down, storing it in a password manager, and keeping it somewhere safe.

You will need this key each time you login on a new device.

## If you've lost your Key

The benefit of the Key is that you can access Anytype and collaborate with others without needing the permission of anybody—not even Anytype. However, encrypted apps work in a way that puts the responsibility for your personal data entirely in your hands.&#x20;

Anytype can't identify, grant access to, or delete individual Vaults. Even if we could, we wouldn't be able to verify with certainty if we're talking to the actual Vault owner or someone else. The level of privacy and anonymity on Anytype makes your Key your responsibility.&#x20;
...
Anytype cannot recover your [vault-and-key.md](vault-and-key.md "mention") if you've completely lost access to your [key.md](key.md "mention").&#x20;
