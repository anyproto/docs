...
**The furniture holding your stuff.** [Types](../organize/types.md) give your Objects categories and prevent your Space from becoming a disorganized mess. Every Object is categorized into a Type, such as a Note, Task, Person, or Book. Even images, videos, and files are their own Type. This makes it easy to find and organize everything in your space.&#x20;
...
* Fpr a person, the Properties might be 'Birthday' and 'Email.'
...
**The magic.** As your Space grows, you need tools to find, organize, and visualize your Objects. Anytype uses [Views](../organize/views.md) to do this:
