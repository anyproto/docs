...
* Put all your 'Events' in a 'Calendar layout' showing those 'coming up next'.&#x20;
* Display all your 'Artwork' in a 'Gallery layout' filtered by 'favorites'.&#x20;
* Have all your 'Tasks' in a 'Kanban layout' grouped by 'assignee'.&#x20;

With a combination of layouts, filters, and sort settings, you can customize Views to suit your exact needs. Additionally, every View can be added to the [customize-and-edit-the-sidebar](customize-and-edit-the-sidebar/ "mention") as [sidebar-widgets.md](customize-and-edit-the-sidebar/sidebar-widgets.md "mention") to gain quick access at all times.&#x20;
