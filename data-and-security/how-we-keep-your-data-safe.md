...
#### Data encryption logic <a href="#keychain" id="keychain"></a>
...
* The second layer is used to encrypt the actual data. We using AES with stream encryption with CFB mode.
