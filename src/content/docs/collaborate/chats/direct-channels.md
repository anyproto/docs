...
A **Direct Channel** is a private, one-on-one connection between you and another user. It is also called a 1:1 channel and has all the capabilities of a regular [Channel](/basics/channels/).
...
![docs direct channel](/assets/docs-direct-channel.jpg)
...
How does this work? When you start a private chat with someone, both of your devices independently create the _same_ chat space using a bit of math based on both your keys. Since you're both starting from the same ingredients, you both land on an identical result — no server needed to set it up or approve it.
