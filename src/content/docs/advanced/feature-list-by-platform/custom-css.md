...
[https://community.anytype.io/t/tutorial-of-custom-css/14234](https://community.anytype.io/t/tutorial-of-custom-css/14234)
...
![custom css](/assets/custom-css.png)
...
[<img src="https://community-static.anytype.io/optimized/2X/d/d1348ecf28fafeb4c079d5cd9ba343b30ee6f9d2_2_690x494.png" alt="image">](https://community-static.anytype.io/original/2X/d/d1348ecf28fafeb4c079d5cd9ba343b30ee6f9d2.png)\
...
If you want to modify a particular element, you can use the Dev tools function in the upper left corner, and then select the element you want to modify, at which time you can see the styles related to it in the **Styles** column.You can try directly modifying the values inside to see what effects it would produce.If you think the effects are not bad, you can copy all this content to your custom.css stylesheet to save.#### Change Icons <a href="#change-icons-7" id="change-icons-7"></a>
...
[<img src="https://community-static.anytype.io/optimized/2X/6/6d596177b0b332db51cd793630c415891538f8f7_2_672x500.png" alt="image">](https://community-static.anytype.io/original/2X/6/6d596177b0b332db51cd793630c415891538f8f7.png)
...
If you have used PS, you should be able to guess that this is a similar mask function, but unfortunately the final result is not very smooth.\\## Examples

[https://community.anytype.io/t/anytype-mist-light-dark-a-brand-new-anytype-theme/16329](https://community.anytype.io/t/anytype-mist-light-dark-a-brand-new-anytype-theme/16329)
