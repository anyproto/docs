...
In your desktop app, click the **?** (Help) button in the lower right corner of your sidebar, then "[Join Our Community](https://community.anytype.io/invites/sig5xTU4ZZ)".![join comminuty](/assets/join-comminuty.png)Alternatively, find the menu bar at the top of the window just below the title bar, and then click on `Help > Report a Bug.`
