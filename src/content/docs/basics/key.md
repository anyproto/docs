...
To find your Key in your [Vault Settings](/settings/vault-settings/):
...
* You can also try recovering your Key from your [OS Key storage manager](/resources/faq/#how-to-recover-my-key-from-my-os-key-storage-manager).
