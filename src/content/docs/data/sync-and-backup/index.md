...
![screenshot_20240411 104810_anytype2](/assets/screenshot_20240411-104810_anytype2.png)

## Alternative sync methods

Anytype also supports two alternative modes:

* [Self-host](/data/sync-and-backup/self-host/) — use your own infrastructure to host and sync your Anytype data.
* [Local-only](/data/sync-and-backup/local-only/) — don't sync through any server at all; your data stays on-device.
...
:::danger
**Do not use network drives or third-party services for sync**—this will likely cause data corruption. [Learn more here](/data/sync-and-backup/local-only/#third-party-services-and-network-drives).
:::
