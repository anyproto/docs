...
* **Local key generation.** Your cryptographic [Key](/basics/key/) is generated locally on your device when you create your [Vault](/basics/vault/). It's never transmitted over the internet or stored on Anytype's servers — only you have it.
