...
1. Open [Channel Settings](/es/settings/channel-settings/) by clicking the Channel name in the Sidebar.
...
* Connect with them privately — opens a [Direct Channel](/es/collaborate/chats/direct-channels/)
...
:::caution
**Currently, you can only share entire Channels — not individual Objects.** If you want to share just one thing publicly with no access controls, use [Web Publishing](/es/collaborate/publish/) instead.
:::
