...
* [Self-host](/es/data/sync-and-backup/self-host/) — use your own infrastructure to host and sync your Anytype data.
* [Local-only](/es/data/sync-and-backup/local-only/) — don't sync through any server at all; your data stays on-device.
