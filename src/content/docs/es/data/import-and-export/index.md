...
1. Go to your [Channel Settings](/es/settings/channel-settings/).
2. Click on **Import** in the side menu.
3. Based on the type of content, choose your option.

![docs import](/assets/docs-import.jpg)
...
![docs export object](/assets/docs-export-object.jpg)
...
![docs export objects](/assets/docs-export-objects.jpg)
...
![docs export view](/assets/docs-export-view.jpg)
...
![docs export](/assets/docs-export.jpg)
...
![docs export options](/assets/docs-export-options.jpg)
