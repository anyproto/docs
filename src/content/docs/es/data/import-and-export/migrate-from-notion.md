...
1.  In Notion, **open Settings.**\\![image 229](/assets/image-229.png)2.  **Open "Connections" and then click "Develop or manage integrations" (or** **[**go directly to the page](https://www.notion.so/profile/integrations)**).**![Open My Connections](/assets/notion-1-2.png)3.  **Create "New integration".**![Create new integration](/assets/notion-1-3.png)4.  **Save a Name for the integration with your selected workspace, and type set to "Internal".**![Set Name for integration](/assets/notion-1-4.png)5. **Important!**
   Go to **Capabilities** and select the following capabilities, then press **Save changes**:

* Read content
*   Read user information![Select capabilities](/assets/notion-1-5.png)6. **Important!**
...
7.  **Copy Internal Integration Secret** for connecting and importing your data.![Copy Internal Integration Secret](/assets/notion-1-6.png)### Step 2: Run the integration in your Anytype space
...
2.  In your Anytype space's settings (click on your space's name in the top left), **select "Import" and choose "Notion"**.![Connect to Anytype integration](/assets/notion-2-1.png)3.  **Enter the Integration Secret** and **click "Import data"**.![Press Confirm](/assets/notion-2-2.png)### FAQ
...
* **Check Page Connections:** Ensure that all pages in your Notion workspace are connected before starting the import process. If a page is not properly connected to the integration, it may not import correctly. See the Step 2 of the [Notion Import Step-by-Step Guide](/es/data/import-and-export/migrate-from-notion/#notion-import-step-by-step-guide) for more details.
