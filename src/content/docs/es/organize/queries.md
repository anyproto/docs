...
A Query is a question you ask your knowledge base—answered instantly and kept up to date automatically. Rather than manually curating a list of things you're looking for, you define the criteria and the Query assembles the result for you as a [View](/es/organize/views/). For example:
...
[Types](/es/organize/types/) and [Properties](/es/organize/properties/) give your Objects structure, Queries then go and turn that structure into useful answers.
...
>
> In other words, the Query is a living answer to: *"What science fiction media do I have?"* See how to [create this Query below](/es/organize/queries/#create-a-query).

#### Types vs. Queries

[Types](/es/organize/types/) are effectively built-in Queries, they are the same thing. However, because every Object can only have one Type, Queries really shine when you want to find and group Objects that belong to multiple Types.
...
2. Choose a **source**. This can be a:
   1. [Type](/es/organize/types/), such as Tasks, Projects, Books.
   2. [Property](/es/organize/properties/), such as all Objects with a 'Reviewed' tag property.
...
To learn more about how to manage Queries and their settings, see the [Views](/es/organize/views/#cómo-funciona) section.

### Sidebar Widget

You can also add [Queries to your Sidebar as a Widget](/es/organize/views/#views-in-sidebar), just like any other View.
...
Edits made to the View of an Inline Query apply only to that specific block. Editing an Inline View inside an Object doesn't affect the master View — that stays intact at the [Type](/es/organize/types/), [Query](/es/organize/queries/), or [Collection](/es/organize/collections/) level. This means each Object can have its own version of the Inline View without ever touching the master.
...
:::note
**For manually-curated groupings, use a** **[**Collection](/es/organize/collections/) **instead.** Queries are rule-driven by the system while Collections are hand-picked by you.
:::
