---
title: "Herramienta Netcheck de Anytype"
---
...
[https://github.com/anyproto/any-sync-tools/releases](https://github.com/anyproto/any-sync-tools/releases)
...
*   If your sync is **working as expected**, your output log should look something like this:\\![screenshot 2023 08 02 at 16.40.02](/assets/screenshot-2023-08-02-at-16.40.02.png)* **If the tool detects any errors:** please provide all details about your network setup, including VPN, proxy, firewalls, and antivirus. In this event, we may request you to run a trace-route or other system tools for further analysis later on.
